      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              <div className="text-3xl lg:text-4xl font-bold text-green-600">2025</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/waitlist" className="hover:text-white transition-colors">Become a Rider</Link></li>
                <li><a href="#benefits" className="hover:text-white transition-colors">Rider App</a></li>
                <li><a href="#benefits" className="hover:text-white transition-colors">Earnings</a></li>
                <li><a href="#benefits" className="hover:text-white transition-colors">Support</a></li>
              </ul>
            </div>
